...
reforms.core.impl.input_column.cljs$lang$applyTo = (function (seq36808){
return reforms.core.impl.input_column.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36808));
});
/**
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__36812){
var vec__36814 = p__36812;
var k = cljs.core.nth.call(null,vec__36814,(0),null);
var _v = cljs.core.nth.call(null,vec__36814,(1),null);
...
reforms.core.impl.simple_checkbox.cljs$core$IFn$_invoke$arity$variadic = (function (checked,p__36818){
var map__36819 = p__36818;
var map__36819__$1 = ((cljs.core.seq_QMARK_.call(null,map__36819))?cljs.core.apply.call(null,cljs.core.hash_map,map__36819):map__36819);
var on_click = cljs.core.get.call(null,map__36819__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"onChange","onChange",-312891301),((function (map__36819,map__36819__$1,on_click){
return (function (p1__36815_SHARP_){
return on_click.call(null,p1__36815_SHARP_.target.checked);
});})(map__36819,map__36819__$1,on_click))
...
reforms.core.impl.simple_checkbox.cljs$lang$applyTo = (function (seq36816){
var G__36817 = cljs.core.first.call(null,seq36816);
var seq36816__$1 = cljs.core.next.call(null,seq36816);
return reforms.core.impl.simple_checkbox.cljs$core$IFn$_invoke$arity$variadic(G__36817,seq36816__$1);
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq36820){
var G__36821 = cljs.core.first.call(null,seq36820);
var seq36820__$1 = cljs.core.next.call(null,seq36820);
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__36821,seq36820__$1);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq36822){
...
var G__36826 = cljs.core.first.call(null,seq36822__$3);
var seq36822__$4 = cljs.core.next.call(null,seq36822__$3);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__36823,G__36824,G__36825,G__36826,seq36822__$4);
});
...
var G__36830__delegate = function (vals){
...
return G__36829.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__36829.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__36829);
} else {
return false;
}
}
...
while (G__36834__i < G__36834__a.length) {G__36834__a[G__36834__i] = arguments[G__36834__i + 0]; ++G__36834__i;}
  vals = new cljs.core.IndexedSeq(G__36834__a,0);
} 
return G__36830__delegate.call(this,vals);};
G__36830.cljs$lang$maxFixedArity = 0;
G__36830.cljs$lang$applyTo = (function (arglist__36835){
var vals = cljs.core.seq(arglist__36835);
return G__36830__delegate(vals);
});
...
var vec__36838 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__36838,(0),null);
var rest_args = cljs.core.nth.call(null,vec__36838,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__36838,attrs,rest_args){
...
});})(vec__36838,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__36838,attrs,rest_args){
return (function (p1__36836_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36836_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__36838,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__36840 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__36840,(0),null);
var rest_args = cljs.core.nth.call(null,vec__36840,(1),null);
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__36848,inner){
var map__36849 = p__36848;
var map__36849__$1 = ((cljs.core.seq_QMARK_.call(null,map__36849))?cljs.core.apply.call(null,cljs.core.hash_map,map__36849):map__36849);
var valid_QMARK_ = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__36849__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq36841){
...
var G__36844 = cljs.core.first.call(null,seq36841__$2);
var seq36841__$3 = cljs.core.next.call(null,seq36841__$2);
var G__36845 = cljs.core.first.call(null,seq36841__$3);
var seq36841__$4 = cljs.core.next.call(null,seq36841__$3);
var G__36846 = cljs.core.first.call(null,seq36841__$4);
var seq36841__$5 = cljs.core.next.call(null,seq36841__$4);
var G__36847 = cljs.core.first.call(null,seq36841__$5);
var seq36841__$6 = cljs.core.next.call(null,seq36841__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__36842,G__36843,G__36844,G__36845,G__36846,G__36847,seq36841__$6);
});
...
return om.core.update_BANG_.call(null,cursor,korks,p1__36850_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq36851){
...
var G__36856 = cljs.core.first.call(null,seq36851__$4);
var seq36851__$5 = cljs.core.next.call(null,seq36851__$4);
var G__36857 = cljs.core.first.call(null,seq36851__$5);
var seq36851__$6 = cljs.core.next.call(null,seq36851__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__36852,G__36853,G__36854,G__36855,G__36856,G__36857,seq36851__$6);
});
/**
 * A spinner.
 * 
...
var vec__36859 = reforms.core.impl.resolve_args.call(null,new cljs.core.Keyword(null,"spinner","spinner",-646071217),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__36859,(0),null);
...
reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq36858){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36858));
});
