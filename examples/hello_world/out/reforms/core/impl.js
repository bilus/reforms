...
reforms.core.impl.input_column.cljs$lang$applyTo = (function (seq37072){
return reforms.core.impl.input_column.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37072));
});
/**
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__37076){
var vec__37078 = p__37076;
var k = cljs.core.nth.call(null,vec__37078,(0),null);
var _v = cljs.core.nth.call(null,vec__37078,(1),null);
...
reforms.core.impl.simple_checkbox.cljs$core$IFn$_invoke$arity$variadic = (function (checked,p__37082){
var map__37083 = p__37082;
var map__37083__$1 = ((cljs.core.seq_QMARK_.call(null,map__37083))?cljs.core.apply.call(null,cljs.core.hash_map,map__37083):map__37083);
var on_click = cljs.core.get.call(null,map__37083__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"onChange","onChange",-312891301),((function (map__37083,map__37083__$1,on_click){
return (function (p1__37079_SHARP_){
return on_click.call(null,p1__37079_SHARP_.target.checked);
});})(map__37083,map__37083__$1,on_click))
...
reforms.core.impl.simple_checkbox.cljs$lang$applyTo = (function (seq37080){
var G__37081 = cljs.core.first.call(null,seq37080);
var seq37080__$1 = cljs.core.next.call(null,seq37080);
return reforms.core.impl.simple_checkbox.cljs$core$IFn$_invoke$arity$variadic(G__37081,seq37080__$1);
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq37084){
var G__37085 = cljs.core.first.call(null,seq37084);
var seq37084__$1 = cljs.core.next.call(null,seq37084);
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__37085,seq37084__$1);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq37086){
var G__37087 = cljs.core.first.call(null,seq37086);
var seq37086__$1 = cljs.core.next.call(null,seq37086);
var G__37088 = cljs.core.first.call(null,seq37086__$1);
var seq37086__$2 = cljs.core.next.call(null,seq37086__$1);
var G__37089 = cljs.core.first.call(null,seq37086__$2);
var seq37086__$3 = cljs.core.next.call(null,seq37086__$2);
var G__37090 = cljs.core.first.call(null,seq37086__$3);
var seq37086__$4 = cljs.core.next.call(null,seq37086__$3);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__37087,G__37088,G__37089,G__37090,seq37086__$4);
});
...
var G__37094__delegate = function (vals){
...
return G__37093.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__37093.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__37093);
} else {
return false;
}
}
...
return (function() { 
var G__37095__delegate = function (args){
...
while (G__37096__i < G__37096__a.length) {G__37096__a[G__37096__i] = arguments[G__37096__i + 0]; ++G__37096__i;}
  args = new cljs.core.IndexedSeq(G__37096__a,0);
} 
return G__37095__delegate.call(this,args);};
G__37095.cljs$lang$maxFixedArity = 0;
G__37095.cljs$lang$applyTo = (function (arglist__37097){
var args = cljs.core.seq(arglist__37097);
return G__37095__delegate(args);
});
...
while (G__37098__i < G__37098__a.length) {G__37098__a[G__37098__i] = arguments[G__37098__i + 0]; ++G__37098__i;}
  vals = new cljs.core.IndexedSeq(G__37098__a,0);
} 
return G__37094__delegate.call(this,vals);};
G__37094.cljs$lang$maxFixedArity = 0;
G__37094.cljs$lang$applyTo = (function (arglist__37099){
var vals = cljs.core.seq(arglist__37099);
return G__37094__delegate(vals);
});
...
var vec__37102 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__37102,(0),null);
var rest_args = cljs.core.nth.call(null,vec__37102,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__37102,attrs,rest_args){
...
});})(vec__37102,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__37102,attrs,rest_args){
return (function (p1__37100_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__37100_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__37102,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__37104 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__37104,(0),null);
var rest_args = cljs.core.nth.call(null,vec__37104,(1),null);
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__37112,inner){
var map__37113 = p__37112;
var map__37113__$1 = ((cljs.core.seq_QMARK_.call(null,map__37113))?cljs.core.apply.call(null,cljs.core.hash_map,map__37113):map__37113);
var valid_QMARK_ = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__37113__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq37105){
var G__37106 = cljs.core.first.call(null,seq37105);
var seq37105__$1 = cljs.core.next.call(null,seq37105);
var G__37107 = cljs.core.first.call(null,seq37105__$1);
var seq37105__$2 = cljs.core.next.call(null,seq37105__$1);
var G__37108 = cljs.core.first.call(null,seq37105__$2);
var seq37105__$3 = cljs.core.next.call(null,seq37105__$2);
var G__37109 = cljs.core.first.call(null,seq37105__$3);
var seq37105__$4 = cljs.core.next.call(null,seq37105__$3);
var G__37110 = cljs.core.first.call(null,seq37105__$4);
var seq37105__$5 = cljs.core.next.call(null,seq37105__$4);
var G__37111 = cljs.core.first.call(null,seq37105__$5);
var seq37105__$6 = cljs.core.next.call(null,seq37105__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__37106,G__37107,G__37108,G__37109,G__37110,G__37111,seq37105__$6);
});
...
return om.core.update_BANG_.call(null,cursor,korks,p1__37114_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq37115){
...
var G__37119 = cljs.core.first.call(null,seq37115__$3);
var seq37115__$4 = cljs.core.next.call(null,seq37115__$3);
var G__37120 = cljs.core.first.call(null,seq37115__$4);
var seq37115__$5 = cljs.core.next.call(null,seq37115__$4);
var G__37121 = cljs.core.first.call(null,seq37115__$5);
var seq37115__$6 = cljs.core.next.call(null,seq37115__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__37116,G__37117,G__37118,G__37119,G__37120,G__37121,seq37115__$6);
});
/**
 * A spinner.
 * 
...
var vec__37123 = reforms.core.impl.resolve_args.call(null,new cljs.core.Keyword(null,"spinner","spinner",-646071217),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__37123,(0),null);
...
reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq37122){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37122));
});
