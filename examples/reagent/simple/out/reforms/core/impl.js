...
var G__6676__delegate = function (vals){
...
return G__6675.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__6675.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__6675);
} else {
return false;
}
}
...
return (function() { 
var G__6677__delegate = function (args){
...
var G__6677 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__6678__i = 0, G__6678__a = new Array(arguments.length -  0);
while (G__6678__i < G__6678__a.length) {G__6678__a[G__6678__i] = arguments[G__6678__i + 0]; ++G__6678__i;}
  args = new cljs.core.IndexedSeq(G__6678__a,0);
} 
return G__6677__delegate.call(this,args);};
G__6677.cljs$lang$maxFixedArity = 0;
G__6677.cljs$lang$applyTo = (function (arglist__6679){
var args = cljs.core.seq(arglist__6679);
return G__6677__delegate(args);
});
...
while (G__6680__i < G__6680__a.length) {G__6680__a[G__6680__i] = arguments[G__6680__i + 0]; ++G__6680__i;}
  vals = new cljs.core.IndexedSeq(G__6680__a,0);
} 
return G__6676__delegate.call(this,vals);};
G__6676.cljs$lang$maxFixedArity = 0;
G__6676.cljs$lang$applyTo = (function (arglist__6681){
var vals = cljs.core.seq(arglist__6681);
return G__6676__delegate(vals);
});
...
var vec__6684 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__6684,(0),null);
var rest_args = cljs.core.nth.call(null,vec__6684,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__6684,attrs,rest_args){
...
});})(vec__6684,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__6684,attrs,rest_args){
return (function (p1__6682_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__6682_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__6684,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__6686 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__6686,(0),null);
var rest_args = cljs.core.nth.call(null,vec__6686,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__6690){
var vec__6692 = p__6690;
var k = cljs.core.nth.call(null,vec__6692,(0),null);
var _v = cljs.core.nth.call(null,vec__6692,(1),null);
...
var vec__6697 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__6697,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq6696){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6696));
});
...
var vec__6699 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__6699,(0),null);
var vec__6700 = cljs.core.nth.call(null,vec__6699,(1),null);
var error = cljs.core.nth.call(null,vec__6700,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq6698){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6698));
});
...
var vec__6702 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__6702,(0),null);
var vec__6703 = cljs.core.nth.call(null,vec__6702,(1),null);
var warning = cljs.core.nth.call(null,vec__6703,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq6701){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6701));
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq6704){
var G__6705 = cljs.core.first.call(null,seq6704);
var seq6704__$1 = cljs.core.next.call(null,seq6704);
var G__6706 = cljs.core.first.call(null,seq6704__$1);
var seq6704__$2 = cljs.core.next.call(null,seq6704__$1);
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__6705,G__6706,seq6704__$2);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq6707){
var G__6708 = cljs.core.first.call(null,seq6707);
var seq6707__$1 = cljs.core.next.call(null,seq6707);
var G__6709 = cljs.core.first.call(null,seq6707__$1);
var seq6707__$2 = cljs.core.next.call(null,seq6707__$1);
var G__6710 = cljs.core.first.call(null,seq6707__$2);
var seq6707__$3 = cljs.core.next.call(null,seq6707__$2);
var G__6711 = cljs.core.first.call(null,seq6707__$3);
var seq6707__$4 = cljs.core.next.call(null,seq6707__$3);
var G__6712 = cljs.core.first.call(null,seq6707__$4);
var seq6707__$5 = cljs.core.next.call(null,seq6707__$4);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__6708,G__6709,G__6710,G__6711,G__6712,seq6707__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__6720,inner){
...
var valid_QMARK_ = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__6721__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq6713){
var G__6714 = cljs.core.first.call(null,seq6713);
var seq6713__$1 = cljs.core.next.call(null,seq6713);
var G__6715 = cljs.core.first.call(null,seq6713__$1);
var seq6713__$2 = cljs.core.next.call(null,seq6713__$1);
var G__6716 = cljs.core.first.call(null,seq6713__$2);
var seq6713__$3 = cljs.core.next.call(null,seq6713__$2);
var G__6717 = cljs.core.first.call(null,seq6713__$3);
var seq6713__$4 = cljs.core.next.call(null,seq6713__$3);
var G__6718 = cljs.core.first.call(null,seq6713__$4);
var seq6713__$5 = cljs.core.next.call(null,seq6713__$4);
var G__6719 = cljs.core.first.call(null,seq6713__$5);
var seq6713__$6 = cljs.core.next.call(null,seq6713__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__6714,G__6715,G__6716,G__6717,G__6718,G__6719,seq6713__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__6722_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq6723){
var G__6724 = cljs.core.first.call(null,seq6723);
var seq6723__$1 = cljs.core.next.call(null,seq6723);
var G__6725 = cljs.core.first.call(null,seq6723__$1);
var seq6723__$2 = cljs.core.next.call(null,seq6723__$1);
var G__6726 = cljs.core.first.call(null,seq6723__$2);
var seq6723__$3 = cljs.core.next.call(null,seq6723__$2);
var G__6727 = cljs.core.first.call(null,seq6723__$3);
var seq6723__$4 = cljs.core.next.call(null,seq6723__$3);
var G__6728 = cljs.core.first.call(null,seq6723__$4);
var seq6723__$5 = cljs.core.next.call(null,seq6723__$4);
var G__6729 = cljs.core.first.call(null,seq6723__$5);
var seq6723__$6 = cljs.core.next.call(null,seq6723__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__6724,G__6725,G__6726,G__6727,G__6728,G__6729,seq6723__$6);
});
/**
 * A spinner.
 * 
...
var vec__6731 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__6731,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq6730){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6730));
});
