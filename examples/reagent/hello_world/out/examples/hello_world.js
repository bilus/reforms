...
return (function (){
var _STAR_options_STAR_8980 = reforms.core.options._STAR_options_STAR_;
...
try{return reforms.reagent.panel.call(null,"Hello, world",reforms.reagent.form.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),((function (_STAR_options_STAR_8980,horizontal_orientation){
return (function (){
return alert("Submitted");
});})(_STAR_options_STAR_8980,horizontal_orientation))
], null),reforms.reagent.text.call(null,"Your name",data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"name","name",1843675177)], null),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Type your name here"),reforms.reagent.form_buttons.call(null,reforms.reagent.button_primary.call(null,"Submit",((function (_STAR_options_STAR_8980,horizontal_orientation){
return (function (){
...
),reforms.reagent.button_default.call(null,"Cancel",((function (_STAR_options_STAR_8980,horizontal_orientation){
return (function (){
return alert("Cancel!");
});})(_STAR_options_STAR_8980,horizontal_orientation))
)),reforms.reagent.checkbox.call(null,"Horizontal form",horizontal_orientation,cljs.core.PersistentVector.EMPTY)));
}finally {reforms.core.options._STAR_options_STAR_ = _STAR_options_STAR_8980;
}});
;})(horizontal_orientation))
});
examples.hello_world.app_state = reagent.core.atom.call(null,"John",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"John"], null));
