...
var G__11526__delegate = function (vals){
...
return G__11525.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__11525.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__11525);
} else {
return false;
}
}
...
while (G__11528__i < G__11528__a.length) {G__11528__a[G__11528__i] = arguments[G__11528__i + 0]; ++G__11528__i;}
  args = new cljs.core.IndexedSeq(G__11528__a,0);
} 
...
while (G__11530__i < G__11530__a.length) {G__11530__a[G__11530__i] = arguments[G__11530__i + 0]; ++G__11530__i;}
  vals = new cljs.core.IndexedSeq(G__11530__a,0);
} 
return G__11526__delegate.call(this,vals);};
G__11526.cljs$lang$maxFixedArity = 0;
G__11526.cljs$lang$applyTo = (function (arglist__11531){
var vals = cljs.core.seq(arglist__11531);
return G__11526__delegate(vals);
});
...
var vec__11534 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__11534,(0),null);
var rest_args = cljs.core.nth.call(null,vec__11534,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__11534,attrs,rest_args){
...
});})(vec__11534,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__11534,attrs,rest_args){
return (function (p1__11532_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__11532_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__11534,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__11536 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__11536,(0),null);
var rest_args = cljs.core.nth.call(null,vec__11536,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__11540){
var vec__11542 = p__11540;
var k = cljs.core.nth.call(null,vec__11542,(0),null);
var _v = cljs.core.nth.call(null,vec__11542,(1),null);
...
var vec__11547 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__11547,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq11546){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11546));
});
...
var vec__11549 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__11549,(0),null);
var vec__11550 = cljs.core.nth.call(null,vec__11549,(1),null);
var error = cljs.core.nth.call(null,vec__11550,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq11548){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11548));
});
...
var vec__11552 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__11552,(0),null);
var vec__11553 = cljs.core.nth.call(null,vec__11552,(1),null);
var warning = cljs.core.nth.call(null,vec__11553,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq11551){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11551));
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq11554){
...
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__11555,G__11556,seq11554__$2);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq11557){
var G__11558 = cljs.core.first.call(null,seq11557);
var seq11557__$1 = cljs.core.next.call(null,seq11557);
var G__11559 = cljs.core.first.call(null,seq11557__$1);
var seq11557__$2 = cljs.core.next.call(null,seq11557__$1);
var G__11560 = cljs.core.first.call(null,seq11557__$2);
var seq11557__$3 = cljs.core.next.call(null,seq11557__$2);
var G__11561 = cljs.core.first.call(null,seq11557__$3);
var seq11557__$4 = cljs.core.next.call(null,seq11557__$3);
var G__11562 = cljs.core.first.call(null,seq11557__$4);
var seq11557__$5 = cljs.core.next.call(null,seq11557__$4);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__11558,G__11559,G__11560,G__11561,G__11562,seq11557__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__11570,inner){
var map__11571 = p__11570;
var map__11571__$1 = ((cljs.core.seq_QMARK_.call(null,map__11571))?cljs.core.apply.call(null,cljs.core.hash_map,map__11571):map__11571);
var valid_QMARK_ = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__11571__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq11563){
...
var G__11567 = cljs.core.first.call(null,seq11563__$3);
var seq11563__$4 = cljs.core.next.call(null,seq11563__$3);
var G__11568 = cljs.core.first.call(null,seq11563__$4);
var seq11563__$5 = cljs.core.next.call(null,seq11563__$4);
var G__11569 = cljs.core.first.call(null,seq11563__$5);
var seq11563__$6 = cljs.core.next.call(null,seq11563__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__11564,G__11565,G__11566,G__11567,G__11568,G__11569,seq11563__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__11572_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq11573){
var G__11574 = cljs.core.first.call(null,seq11573);
var seq11573__$1 = cljs.core.next.call(null,seq11573);
var G__11575 = cljs.core.first.call(null,seq11573__$1);
var seq11573__$2 = cljs.core.next.call(null,seq11573__$1);
var G__11576 = cljs.core.first.call(null,seq11573__$2);
var seq11573__$3 = cljs.core.next.call(null,seq11573__$2);
var G__11577 = cljs.core.first.call(null,seq11573__$3);
var seq11573__$4 = cljs.core.next.call(null,seq11573__$3);
var G__11578 = cljs.core.first.call(null,seq11573__$4);
var seq11573__$5 = cljs.core.next.call(null,seq11573__$4);
var G__11579 = cljs.core.first.call(null,seq11573__$5);
var seq11573__$6 = cljs.core.next.call(null,seq11573__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__11574,G__11575,G__11576,G__11577,G__11578,G__11579,seq11573__$6);
});
/**
 * A spinner.
 * 
...
var vec__11581 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__11581,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq11580){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11580));
});
