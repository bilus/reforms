...
var args78564 = [];
var len__5651__auto___78567 = arguments.length;
var i__5652__auto___78568 = (0);
while(true){
if((i__5652__auto___78568 < len__5651__auto___78567)){
args78564.push((arguments[i__5652__auto___78568]));

var G__78569 = (i__5652__auto___78568 + (1));
i__5652__auto___78568 = G__78569;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args78564.length)].join('')));
