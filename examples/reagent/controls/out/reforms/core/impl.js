...
var G__9101__delegate = function (vals){
...
return G__9100.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__9100.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__9100);
} else {
return false;
}
}
...
return (function() { 
var G__9102__delegate = function (args){
...
return G__9102__delegate.call(this,args);};
G__9102.cljs$lang$maxFixedArity = 0;
G__9102.cljs$lang$applyTo = (function (arglist__9104){
var args = cljs.core.seq(arglist__9104);
return G__9102__delegate(args);
});
...
while (G__9105__i < G__9105__a.length) {G__9105__a[G__9105__i] = arguments[G__9105__i + 0]; ++G__9105__i;}
  vals = new cljs.core.IndexedSeq(G__9105__a,0);
} 
return G__9101__delegate.call(this,vals);};
G__9101.cljs$lang$maxFixedArity = 0;
G__9101.cljs$lang$applyTo = (function (arglist__9106){
var vals = cljs.core.seq(arglist__9106);
return G__9101__delegate(vals);
});
...
var vec__9109 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__9109,(0),null);
var rest_args = cljs.core.nth.call(null,vec__9109,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__9109,attrs,rest_args){
...
});})(vec__9109,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__9109,attrs,rest_args){
return (function (p1__9107_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9107_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__9109,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__9111 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__9111,(0),null);
var rest_args = cljs.core.nth.call(null,vec__9111,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__9115){
var vec__9117 = p__9115;
var k = cljs.core.nth.call(null,vec__9117,(0),null);
var _v = cljs.core.nth.call(null,vec__9117,(1),null);
...
var vec__9122 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__9122,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq9121){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9121));
});
...
var vec__9124 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__9124,(0),null);
var vec__9125 = cljs.core.nth.call(null,vec__9124,(1),null);
var error = cljs.core.nth.call(null,vec__9125,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq9123){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9123));
});
...
var vec__9127 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__9127,(0),null);
var vec__9128 = cljs.core.nth.call(null,vec__9127,(1),null);
var warning = cljs.core.nth.call(null,vec__9128,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq9126){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9126));
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq9129){
...
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__9130,G__9131,seq9129__$2);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq9132){
...
var G__9135 = cljs.core.first.call(null,seq9132__$2);
var seq9132__$3 = cljs.core.next.call(null,seq9132__$2);
var G__9136 = cljs.core.first.call(null,seq9132__$3);
var seq9132__$4 = cljs.core.next.call(null,seq9132__$3);
var G__9137 = cljs.core.first.call(null,seq9132__$4);
var seq9132__$5 = cljs.core.next.call(null,seq9132__$4);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__9133,G__9134,G__9135,G__9136,G__9137,seq9132__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__9145,inner){
var map__9146 = p__9145;
var map__9146__$1 = ((cljs.core.seq_QMARK_.call(null,map__9146))?cljs.core.apply.call(null,cljs.core.hash_map,map__9146):map__9146);
var valid_QMARK_ = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__9146__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq9138){
var G__9139 = cljs.core.first.call(null,seq9138);
var seq9138__$1 = cljs.core.next.call(null,seq9138);
var G__9140 = cljs.core.first.call(null,seq9138__$1);
var seq9138__$2 = cljs.core.next.call(null,seq9138__$1);
var G__9141 = cljs.core.first.call(null,seq9138__$2);
var seq9138__$3 = cljs.core.next.call(null,seq9138__$2);
var G__9142 = cljs.core.first.call(null,seq9138__$3);
var seq9138__$4 = cljs.core.next.call(null,seq9138__$3);
var G__9143 = cljs.core.first.call(null,seq9138__$4);
var seq9138__$5 = cljs.core.next.call(null,seq9138__$4);
var G__9144 = cljs.core.first.call(null,seq9138__$5);
var seq9138__$6 = cljs.core.next.call(null,seq9138__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__9139,G__9140,G__9141,G__9142,G__9143,G__9144,seq9138__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__9147_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq9148){
var G__9149 = cljs.core.first.call(null,seq9148);
var seq9148__$1 = cljs.core.next.call(null,seq9148);
var G__9150 = cljs.core.first.call(null,seq9148__$1);
var seq9148__$2 = cljs.core.next.call(null,seq9148__$1);
var G__9151 = cljs.core.first.call(null,seq9148__$2);
var seq9148__$3 = cljs.core.next.call(null,seq9148__$2);
var G__9152 = cljs.core.first.call(null,seq9148__$3);
var seq9148__$4 = cljs.core.next.call(null,seq9148__$3);
var G__9153 = cljs.core.first.call(null,seq9148__$4);
var seq9148__$5 = cljs.core.next.call(null,seq9148__$4);
var G__9154 = cljs.core.first.call(null,seq9148__$5);
var seq9148__$6 = cljs.core.next.call(null,seq9148__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__9149,G__9150,G__9151,G__9152,G__9153,G__9154,seq9148__$6);
});
/**
 * A spinner.
 * 
...
var vec__9156 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__9156,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq9155){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9155));
});
