...
var G__13931 = this$;
if(G__13931){
var bit__5013__auto__ = (G__13931.cljs$lang$protocol_mask$partition1$ & (16384));
if((bit__5013__auto__) || (G__13931.cljs$core$IAtom$)){
return true;
} else {
if((!G__13931.cljs$lang$protocol_mask$partition1$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IAtom,G__13931);
} else {
return false;
}
}
...
var G__13932 = null;
var G__13932__2 = (function (this$,v){
return cljs.core.reset_BANG_.call(null,this$,v);
});
var G__13932__3 = (function (this$,ks,v){
return reforms.binding.reagent.do_reset_BANG_.call(null,this$,ks,v);
});
G__13932 = function(this$,ks,v){
switch(arguments.length){
case 2:
return G__13932__2.call(this,this$,ks);
case 3:
return G__13932__3.call(this,this$,ks,v);
}
