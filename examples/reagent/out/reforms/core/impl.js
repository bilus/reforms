...
var G__33850__delegate = function (vals){
...
return G__33849.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__33849.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__33849);
} else {
return false;
}
}
...
return (function() { 
var G__33851__delegate = function (args){
...
return G__33851__delegate.call(this,args);};
G__33851.cljs$lang$maxFixedArity = 0;
G__33851.cljs$lang$applyTo = (function (arglist__33853){
var args = cljs.core.seq(arglist__33853);
return G__33851__delegate(args);
});
...
while (G__33854__i < G__33854__a.length) {G__33854__a[G__33854__i] = arguments[G__33854__i + 0]; ++G__33854__i;}
  vals = new cljs.core.IndexedSeq(G__33854__a,0);
} 
return G__33850__delegate.call(this,vals);};
G__33850.cljs$lang$maxFixedArity = 0;
G__33850.cljs$lang$applyTo = (function (arglist__33855){
var vals = cljs.core.seq(arglist__33855);
return G__33850__delegate(vals);
});
...
var vec__33858 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__33858,(0),null);
var rest_args = cljs.core.nth.call(null,vec__33858,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__33858,attrs,rest_args){
...
});})(vec__33858,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__33858,attrs,rest_args){
return (function (p1__33856_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__33856_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__33858,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__33860 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__33860,(0),null);
var rest_args = cljs.core.nth.call(null,vec__33860,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__33864){
var vec__33866 = p__33864;
var k = cljs.core.nth.call(null,vec__33866,(0),null);
var _v = cljs.core.nth.call(null,vec__33866,(1),null);
...
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(argseq__5389__auto__);
});

reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic = (function (args){
var vec__33871 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__33871,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq33870){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33870));
});
reforms.core.impl.error_label = (function reforms$core$impl$error_label(){
var argseq__5389__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(argseq__5389__auto__);
});

reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic = (function (args){
var vec__33873 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__33873,(0),null);
var vec__33874 = cljs.core.nth.call(null,vec__33873,(1),null);
var error = cljs.core.nth.call(null,vec__33874,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq33872){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33872));
});
reforms.core.impl.warning_label = (function reforms$core$impl$warning_label(){
var argseq__5389__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(argseq__5389__auto__);
});

reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic = (function (args){
var vec__33876 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__33876,(0),null);
var vec__33877 = cljs.core.nth.call(null,vec__33876,(1),null);
var warning = cljs.core.nth.call(null,vec__33877,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq33875){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33875));
});
...
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5389__auto__);
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq33878){
...
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__33879,G__33880,seq33878__$2);
});
reforms.core.impl.labeled_control = (function reforms$core$impl$labeled_control(){
var argseq__5389__auto__ = ((((5) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(5)),(0))):null);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),argseq__5389__auto__);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq33881){
...
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__33882,G__33883,G__33884,G__33885,G__33886,seq33881__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__33894,inner){
...
var valid_QMARK_ = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__33895__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
return reforms.core.impl.labeled_control.call(null,base_key,inline,clojure.string.join.call(null," ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__4349__auto__ = warning;
if(cljs.core.truth_(or__4349__auto__)){
return or__4349__auto__;
} else {
return in_progress;
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq33887){
...
var G__33890 = cljs.core.first.call(null,seq33887__$2);
var seq33887__$3 = cljs.core.next.call(null,seq33887__$2);
var G__33891 = cljs.core.first.call(null,seq33887__$3);
var seq33887__$4 = cljs.core.next.call(null,seq33887__$3);
var G__33892 = cljs.core.first.call(null,seq33887__$4);
var seq33887__$5 = cljs.core.next.call(null,seq33887__$4);
var G__33893 = cljs.core.first.call(null,seq33887__$5);
var seq33887__$6 = cljs.core.next.call(null,seq33887__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__33888,G__33889,G__33890,G__33891,G__33892,G__33893,seq33887__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__33896_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq33897){
var G__33898 = cljs.core.first.call(null,seq33897);
var seq33897__$1 = cljs.core.next.call(null,seq33897);
var G__33899 = cljs.core.first.call(null,seq33897__$1);
var seq33897__$2 = cljs.core.next.call(null,seq33897__$1);
var G__33900 = cljs.core.first.call(null,seq33897__$2);
var seq33897__$3 = cljs.core.next.call(null,seq33897__$2);
var G__33901 = cljs.core.first.call(null,seq33897__$3);
var seq33897__$4 = cljs.core.next.call(null,seq33897__$3);
var G__33902 = cljs.core.first.call(null,seq33897__$4);
var seq33897__$5 = cljs.core.next.call(null,seq33897__$4);
var G__33903 = cljs.core.first.call(null,seq33897__$5);
var seq33897__$6 = cljs.core.next.call(null,seq33897__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__33898,G__33899,G__33900,G__33901,G__33902,G__33903,seq33897__$6);
});
/**
 * A spinner.
 * 
...
var vec__33905 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__33905,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq33904){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33904));
});
