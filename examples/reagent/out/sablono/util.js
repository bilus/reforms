...
sablono.util.ToString = (function (){var obj35332 = {};
return obj35332;
})();
...
sablono.util.ToURI = (function (){var obj35334 = {};
return obj35334;
})();
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq35335){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35335));
});
/**
...
var vec__35337 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__35337,(0),null);
var words = cljs.core.nthnext.call(null,vec__35337,(1));
...
var G__35339 = clojure.set.rename_keys.call(null,m,kmap);
var G__35339__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__35339,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__35339);
return G__35339__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__35340_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__35340_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__35340_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__35340_SHARP_)){
return p1__35340_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__35340_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq35341){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35341));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__35345,(0),null);
var names = cljs.core.nth.call(null,vec__35345,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__35345,tag_name,names){
return (function (p1__35342_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__35342_SHARP_));
});})(matches,vec__35345,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__35345,tag_name,names){
return (function (p1__35343_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__35343_SHARP_));
});})(matches,vec__35345,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__35346){
var vec__35349 = p__35346;
var tag = cljs.core.nth.call(null,vec__35349,(0),null);
var content = cljs.core.nthnext.call(null,vec__35349,(1));
...
var vec__35350 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__35350,(0),null);
var id = cljs.core.nth.call(null,vec__35350,(1),null);
var class$ = cljs.core.nth.call(null,vec__35350,(2),null);
