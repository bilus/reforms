...
var G__19971 = this$;
if(G__19971){
var bit__5013__auto__ = (G__19971.cljs$lang$protocol_mask$partition1$ & (16384));
if((bit__5013__auto__) || (G__19971.cljs$core$IAtom$)){
return true;
} else {
if((!G__19971.cljs$lang$protocol_mask$partition1$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IAtom,G__19971);
} else {
return false;
}
}
...
var G__19972 = null;
var G__19972__2 = (function (this$,v){
return cljs.core.reset_BANG_.call(null,this$,v);
});
var G__19972__3 = (function (this$,ks,v){
return reforms.binding.reagent.do_reset_BANG_.call(null,this$,ks,v);
});
G__19972 = function(this$,ks,v){
switch(arguments.length){
case 2:
return G__19972__2.call(this,this$,ks);
case 3:
return G__19972__3.call(this,this$,ks,v);
}
