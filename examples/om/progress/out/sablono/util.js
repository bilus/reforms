...
var len__5651__auto___36371 = arguments.length;
var i__5652__auto___36372 = (0);
while(true){
if((i__5652__auto___36372 < len__5651__auto___36371)){
args__5658__auto__.push((arguments[i__5652__auto___36372]));

var G__36373 = (i__5652__auto___36372 + (1));
i__5652__auto___36372 = G__36373;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq36370){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36370));
});
/**
...
var vec__36375 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__36375,(0),null);
var words = cljs.core.nthnext.call(null,vec__36375,(1));
...
var G__36377 = clojure.set.rename_keys.call(null,m,kmap);
var G__36377__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__36377,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__36377);
return G__36377__$1;
} else {
return m;
}
...
var args__5658__auto__ = [];
var len__5651__auto___36380 = arguments.length;
var i__5652__auto___36381 = (0);
while(true){
if((i__5652__auto___36381 < len__5651__auto___36380)){
args__5658__auto__.push((arguments[i__5652__auto___36381]));

var G__36382 = (i__5652__auto___36381 + (1));
i__5652__auto___36381 = G__36382;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__36378_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__36378_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36378_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__36378_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq36379){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36379));
});
/**
...
var vec__36386 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__36386,(0),null);
var names = cljs.core.nth.call(null,vec__36386,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__36386,tag_name,names){
return (function (p1__36383_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__36383_SHARP_));
});})(matches,vec__36386,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__36386,tag_name,names){
return (function (p1__36384_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__36384_SHARP_));
});})(matches,vec__36386,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__36387){
var vec__36390 = p__36387;
var tag = cljs.core.nth.call(null,vec__36390,(0),null);
var content = cljs.core.nthnext.call(null,vec__36390,(1));
...
var vec__36391 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__36391,(0),null);
var id = cljs.core.nth.call(null,vec__36391,(1),null);
var class$ = cljs.core.nth.call(null,vec__36391,(2),null);
