...
var args174707 = [];
var len__5767__auto___174710 = arguments.length;
var i__5768__auto___174711 = (0);
while(true){
if((i__5768__auto___174711 < len__5767__auto___174710)){
args174707.push((arguments[i__5768__auto___174711]));

var G__174712 = (i__5768__auto___174711 + (1));
i__5768__auto___174711 = G__174712;
continue;
} else {
}
break;
...
var G__174709 = args174707.length;
switch (G__174709) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args174707.length)].join('')));
