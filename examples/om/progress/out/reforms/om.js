...
goog.require('reforms.binding.om');
/**
...
reforms.om.get_options = reforms.core.get_options;
 ...
 * See `button`.
 */
reforms.om.button_primary = reforms.core.button_primary;
 ...
 */
reforms.om.text = reforms.core.text;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.datetime_local = reforms.core.datetime_local;
 ...
 * See `button`.
 */
reforms.om.button_default = reforms.core.button_default;
 ...
 * button-1 ... button-n
 */
reforms.om.form_buttons = reforms.core.form_buttons;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.email = reforms.core.email;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.date = reforms.core.date;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.week = reforms.core.week;
 ...
 */
reforms.om.group_title = reforms.core.group_title;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.color = reforms.core.color;
 ...
 * - :validation-error-fn  - (optional) lambda <korks> -> <error message>; internal
 */
reforms.om.radio = reforms.core.radio;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.number = reforms.core.number;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.password = reforms.core.password;
 ...
 * - :validation-error-fn  - (optional) lambda <korks> -> <error message>; internal
 */
reforms.om.checkbox = reforms.core.checkbox;
 ...
 */
reforms.om.button = reforms.core.button;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.time = reforms.core.time;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.month = reforms.core.month;

reforms.om.set_options_BANG_ = reforms.core.set_options_BANG_;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.search = reforms.core.search;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.tel = reforms.core.tel;
 ...
 * - attrs                 - (optional) attributes handed over to React (see https://github.com/r0man/sablono#html-attributes)
 */
reforms.om.spinner = reforms.core.spinner;
 ...
 * - attrs        - (optional) attributes handed over to React (see https://github.com/r0man/sablono#html-attributes)
 */
reforms.om.button_group = reforms.core.button_group;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.datetime = reforms.core.datetime;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.om.url = reforms.core.url;
