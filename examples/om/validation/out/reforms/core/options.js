...
var args173989 = [];
var len__5767__auto___173992 = arguments.length;
var i__5768__auto___173993 = (0);
while(true){
if((i__5768__auto___173993 < len__5767__auto___173992)){
args173989.push((arguments[i__5768__auto___173993]));

var G__173994 = (i__5768__auto___173993 + (1));
i__5768__auto___173993 = G__173994;
continue;
} else {
}
break;
...
var G__173991 = args173989.length;
switch (G__173991) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args173989.length)].join('')));
