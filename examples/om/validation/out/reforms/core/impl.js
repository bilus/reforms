...
var G__20210__delegate = function (vals){
...
return G__20209.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__20209.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__20209);
} else {
return false;
}
}
...
while (G__20212__i < G__20212__a.length) {G__20212__a[G__20212__i] = arguments[G__20212__i + 0]; ++G__20212__i;}
  args = new cljs.core.IndexedSeq(G__20212__a,0);
} 
...
var G__20210 = function (var_args){
var vals = null;
if (arguments.length > 0) {
...
while (G__20214__i < G__20214__a.length) {G__20214__a[G__20214__i] = arguments[G__20214__i + 0]; ++G__20214__i;}
  vals = new cljs.core.IndexedSeq(G__20214__a,0);
} 
return G__20210__delegate.call(this,vals);};
G__20210.cljs$lang$maxFixedArity = 0;
G__20210.cljs$lang$applyTo = (function (arglist__20215){
var vals = cljs.core.seq(arglist__20215);
return G__20210__delegate(vals);
});
G__20210.cljs$core$IFn$_invoke$arity$variadic = G__20210__delegate;
return G__20210;
})()
,attrs,extensions);
});
...
var vec__20218 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__20218,(0),null);
var rest_args = cljs.core.nth.call(null,vec__20218,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__20218,attrs,rest_args){
...
});})(vec__20218,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__20218,attrs,rest_args){
return (function (p1__20216_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20216_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__20218,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__20220 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__20220,(0),null);
var rest_args = cljs.core.nth.call(null,vec__20220,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__20224){
var vec__20226 = p__20224;
var k = cljs.core.nth.call(null,vec__20226,(0),null);
var _v = cljs.core.nth.call(null,vec__20226,(1),null);
...
var vec__20231 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__20231,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq20230){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20230));
});
...
var vec__20233 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__20233,(0),null);
var vec__20234 = cljs.core.nth.call(null,vec__20233,(1),null);
var error = cljs.core.nth.call(null,vec__20234,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq20232){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20232));
});
...
var vec__20236 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__20236,(0),null);
var vec__20237 = cljs.core.nth.call(null,vec__20236,(1),null);
var warning = cljs.core.nth.call(null,vec__20237,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq20235){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20235));
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq20238){
...
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__20239,G__20240,seq20238__$2);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq20241){
...
var G__20244 = cljs.core.first.call(null,seq20241__$2);
var seq20241__$3 = cljs.core.next.call(null,seq20241__$2);
var G__20245 = cljs.core.first.call(null,seq20241__$3);
var seq20241__$4 = cljs.core.next.call(null,seq20241__$3);
var G__20246 = cljs.core.first.call(null,seq20241__$4);
var seq20241__$5 = cljs.core.next.call(null,seq20241__$4);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__20242,G__20243,G__20244,G__20245,G__20246,seq20241__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__20254,inner){
...
var valid_QMARK_ = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__20255__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq20247){
...
var G__20251 = cljs.core.first.call(null,seq20247__$3);
var seq20247__$4 = cljs.core.next.call(null,seq20247__$3);
var G__20252 = cljs.core.first.call(null,seq20247__$4);
var seq20247__$5 = cljs.core.next.call(null,seq20247__$4);
var G__20253 = cljs.core.first.call(null,seq20247__$5);
var seq20247__$6 = cljs.core.next.call(null,seq20247__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__20248,G__20249,G__20250,G__20251,G__20252,G__20253,seq20247__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__20256_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq20257){
...
var G__20262 = cljs.core.first.call(null,seq20257__$4);
var seq20257__$5 = cljs.core.next.call(null,seq20257__$4);
var G__20263 = cljs.core.first.call(null,seq20257__$5);
var seq20257__$6 = cljs.core.next.call(null,seq20257__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__20258,G__20259,G__20260,G__20261,G__20262,G__20263,seq20257__$6);
});
/**
 * A spinner.
 * 
...
var vec__20265 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__20265,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq20264){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20264));
});
