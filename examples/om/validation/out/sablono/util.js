...
sablono.util.ToString = (function (){var obj21339 = {};
return obj21339;
})();
...
return (function (){var or__4339__auto__ = (sablono.util.to_str[goog.typeOf(x__4975__auto__)]);
if(or__4339__auto__){
return or__4339__auto__;
} else {
var or__4339__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj21341 = {};
return obj21341;
})();
...
var x__4975__auto__ = (((x == null))?null:x);
return (function (){var or__4339__auto__ = (sablono.util.to_uri[goog.typeOf(x__4975__auto__)]);
if(or__4339__auto__){
return or__4339__auto__;
} else {
var or__4339__auto____$1 = (sablono.util.to_uri["_"]);
if(or__4339__auto____$1){
return or__4339__auto____$1;
} else {
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__5379__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq21342){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21342));
});
/**
...
var vec__21344 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__21344,(0),null);
var words = cljs.core.nthnext.call(null,vec__21344,(1));
...
var G__21346 = clojure.set.rename_keys.call(null,m,kmap);
var G__21346__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__21346,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__21346);
return G__21346__$1;
} else {
return m;
}
...
var argseq__5379__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5379__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__21347_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__21347_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21347_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__21347_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq21348){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21348));
});
/**
...
var vec__21352 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__21352,(0),null);
var names = cljs.core.nth.call(null,vec__21352,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__21352,tag_name,names){
return (function (p1__21349_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21349_SHARP_));
});})(matches,vec__21352,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__21352,tag_name,names){
return (function (p1__21350_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21350_SHARP_));
});})(matches,vec__21352,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__21353){
var vec__21356 = p__21353;
var tag = cljs.core.nth.call(null,vec__21356,(0),null);
var content = cljs.core.nthnext.call(null,vec__21356,(1));
...
var vec__21357 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21357,(0),null);
var id = cljs.core.nth.call(null,vec__21357,(1),null);
var class$ = cljs.core.nth.call(null,vec__21357,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4339__auto__ = x__$1.hasDomain();
