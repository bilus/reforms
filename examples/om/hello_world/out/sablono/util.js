...
sablono.util.ToString = (function (){var obj17308 = {};
return obj17308;
})();
...
sablono.util.ToURI = (function (){var obj17310 = {};
return obj17310;
})();
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq17311){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17311));
});
/**
...
var vec__17313 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__17313,(0),null);
var words = cljs.core.nthnext.call(null,vec__17313,(1));
...
var G__17315 = clojure.set.rename_keys.call(null,m,kmap);
var G__17315__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__17315,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__17315);
return G__17315__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__17316_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__17316_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17316_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__17316_SHARP_)){
return p1__17316_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17316_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq17317){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17317));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__17321,(0),null);
var names = cljs.core.nth.call(null,vec__17321,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17321,tag_name,names){
return (function (p1__17318_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__17318_SHARP_));
});})(matches,vec__17321,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17321,tag_name,names){
return (function (p1__17319_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__17319_SHARP_));
});})(matches,vec__17321,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__17322){
var vec__17325 = p__17322;
var tag = cljs.core.nth.call(null,vec__17325,(0),null);
var content = cljs.core.nthnext.call(null,vec__17325,(1));
...
var vec__17326 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__17326,(0),null);
var id = cljs.core.nth.call(null,vec__17326,(1),null);
var class$ = cljs.core.nth.call(null,vec__17326,(2),null);
