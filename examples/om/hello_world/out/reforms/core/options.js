...
var args157344 = [];
var len__5767__auto___157347 = arguments.length;
var i__5768__auto___157348 = (0);
while(true){
if((i__5768__auto___157348 < len__5767__auto___157347)){
args157344.push((arguments[i__5768__auto___157348]));

var G__157349 = (i__5768__auto___157348 + (1));
i__5768__auto___157348 = G__157349;
continue;
} else {
}
break;
...
var G__157346 = args157344.length;
switch (G__157346) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args157344.length)].join('')));
