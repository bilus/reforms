...
var args172670 = [];
var len__5767__auto___172673 = arguments.length;
var i__5768__auto___172674 = (0);
while(true){
if((i__5768__auto___172674 < len__5767__auto___172673)){
args172670.push((arguments[i__5768__auto___172674]));

var G__172675 = (i__5768__auto___172674 + (1));
i__5768__auto___172674 = G__172675;
continue;
} else {
}
break;
...
var G__172672 = args172670.length;
switch (G__172672) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args172670.length)].join('')));
