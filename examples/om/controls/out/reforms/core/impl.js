...
var G__12397__delegate = function (vals){
...
return G__12396.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__12396.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__12396);
} else {
return false;
}
}
...
return (function() { 
var G__12398__delegate = function (args){
...
while (G__12399__i < G__12399__a.length) {G__12399__a[G__12399__i] = arguments[G__12399__i + 0]; ++G__12399__i;}
  args = new cljs.core.IndexedSeq(G__12399__a,0);
} 
return G__12398__delegate.call(this,args);};
...
return G__12398__delegate(args);
});
...
while (G__12401__i < G__12401__a.length) {G__12401__a[G__12401__i] = arguments[G__12401__i + 0]; ++G__12401__i;}
  vals = new cljs.core.IndexedSeq(G__12401__a,0);
} 
return G__12397__delegate.call(this,vals);};
G__12397.cljs$lang$maxFixedArity = 0;
G__12397.cljs$lang$applyTo = (function (arglist__12402){
var vals = cljs.core.seq(arglist__12402);
return G__12397__delegate(vals);
});
...
var vec__12405 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__12405,(0),null);
var rest_args = cljs.core.nth.call(null,vec__12405,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__12405,attrs,rest_args){
...
});})(vec__12405,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__12405,attrs,rest_args){
return (function (p1__12403_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__12403_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__12405,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__12407 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__12407,(0),null);
var rest_args = cljs.core.nth.call(null,vec__12407,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__12411){
var vec__12413 = p__12411;
var k = cljs.core.nth.call(null,vec__12413,(0),null);
var _v = cljs.core.nth.call(null,vec__12413,(1),null);
...
var vec__12418 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__12418,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq12417){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12417));
});
...
var vec__12420 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__12420,(0),null);
var vec__12421 = cljs.core.nth.call(null,vec__12420,(1),null);
var error = cljs.core.nth.call(null,vec__12421,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq12419){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12419));
});
...
var vec__12423 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__12423,(0),null);
var vec__12424 = cljs.core.nth.call(null,vec__12423,(1),null);
var warning = cljs.core.nth.call(null,vec__12424,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq12422){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12422));
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq12425){
var G__12426 = cljs.core.first.call(null,seq12425);
var seq12425__$1 = cljs.core.next.call(null,seq12425);
var G__12427 = cljs.core.first.call(null,seq12425__$1);
var seq12425__$2 = cljs.core.next.call(null,seq12425__$1);
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__12426,G__12427,seq12425__$2);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq12428){
var G__12429 = cljs.core.first.call(null,seq12428);
var seq12428__$1 = cljs.core.next.call(null,seq12428);
var G__12430 = cljs.core.first.call(null,seq12428__$1);
var seq12428__$2 = cljs.core.next.call(null,seq12428__$1);
var G__12431 = cljs.core.first.call(null,seq12428__$2);
var seq12428__$3 = cljs.core.next.call(null,seq12428__$2);
var G__12432 = cljs.core.first.call(null,seq12428__$3);
var seq12428__$4 = cljs.core.next.call(null,seq12428__$3);
var G__12433 = cljs.core.first.call(null,seq12428__$4);
var seq12428__$5 = cljs.core.next.call(null,seq12428__$4);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__12429,G__12430,G__12431,G__12432,G__12433,seq12428__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__12441,inner){
var map__12442 = p__12441;
var map__12442__$1 = ((cljs.core.seq_QMARK_.call(null,map__12442))?cljs.core.apply.call(null,cljs.core.hash_map,map__12442):map__12442);
var valid_QMARK_ = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__12442__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq12434){
var G__12435 = cljs.core.first.call(null,seq12434);
var seq12434__$1 = cljs.core.next.call(null,seq12434);
var G__12436 = cljs.core.first.call(null,seq12434__$1);
var seq12434__$2 = cljs.core.next.call(null,seq12434__$1);
var G__12437 = cljs.core.first.call(null,seq12434__$2);
var seq12434__$3 = cljs.core.next.call(null,seq12434__$2);
var G__12438 = cljs.core.first.call(null,seq12434__$3);
var seq12434__$4 = cljs.core.next.call(null,seq12434__$3);
var G__12439 = cljs.core.first.call(null,seq12434__$4);
var seq12434__$5 = cljs.core.next.call(null,seq12434__$4);
var G__12440 = cljs.core.first.call(null,seq12434__$5);
var seq12434__$6 = cljs.core.next.call(null,seq12434__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__12435,G__12436,G__12437,G__12438,G__12439,G__12440,seq12434__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__12443_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq12444){
...
var G__12448 = cljs.core.first.call(null,seq12444__$3);
var seq12444__$4 = cljs.core.next.call(null,seq12444__$3);
var G__12449 = cljs.core.first.call(null,seq12444__$4);
var seq12444__$5 = cljs.core.next.call(null,seq12444__$4);
var G__12450 = cljs.core.first.call(null,seq12444__$5);
var seq12444__$6 = cljs.core.next.call(null,seq12444__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__12445,G__12446,G__12447,G__12448,G__12449,G__12450,seq12444__$6);
});
/**
 * A spinner.
 * 
...
var vec__12452 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__12452,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq12451){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12451));
});
