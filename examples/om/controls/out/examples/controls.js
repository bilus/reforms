...
if(typeof examples.controls.t_examples$controls172580 !== 'undefined'){
} else {
...
*/
examples.controls.t_examples$controls172580 = (function (simple_view,data,_owner,meta172581){
this.simple_view = simple_view;
this.data = data;
this._owner = _owner;
this.meta172581 = meta172581;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
examples.controls.t_examples$controls172580.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_172582,meta172581__$1){
var self__ = this;
var _172582__$1 = this;
return (new examples.controls.t_examples$controls172580(self__.simple_view,self__.data,self__._owner,meta172581__$1));
});

examples.controls.t_examples$controls172580.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_172582){
var self__ = this;
var _172582__$1 = this;
return self__.meta172581;
});

examples.controls.t_examples$controls172580.prototype.om$core$IRender$ = true;

examples.controls.t_examples$controls172580.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return React.createElement("div",null,React.createElement("h1",{"key": "h1"},"Supported controls"),React.createElement("div",{"className": "row"},React.createElement("div",{"className": "col col-md-6"},React.createElement("h4",null,"Panel"),sablono.interpreter.interpret.call(null,reforms.om.panel.call(null,"Panel title",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 2"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 3"], null))),React.createElement("h4",null,"Auto-aligning form with validation"),sablono.interpreter.interpret.call(null,(function (){var _STAR_options_STAR_172603 = reforms.core.options._STAR_options_STAR_;
...
examples.controls.t_examples$controls172580.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"simple-view","simple-view",-1334203951,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"data","data",1407862150,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"data","data",1407862150,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta172581","meta172581",1859325596,null)], null);
});

examples.controls.t_examples$controls172580.cljs$lang$type = true;

examples.controls.t_examples$controls172580.cljs$lang$ctorStr = "examples.controls/t_examples$controls172580";

examples.controls.t_examples$controls172580.cljs$lang$ctorPrWriter = (function (this__5307__auto__,writer__5308__auto__,opt__5309__auto__){
return cljs.core._write.call(null,writer__5308__auto__,"examples.controls/t_examples$controls172580");
});

examples.controls.__GT_t_examples$controls172580 = (function examples$controls$simple_view_$___GT_t_examples$controls172580(simple_view__$1,data__$1,_owner__$1,meta172581){
return (new examples.controls.t_examples$controls172580(simple_view__$1,data__$1,_owner__$1,meta172581));
});

}

return (new examples.controls.t_examples$controls172580(examples$controls$simple_view,data,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
examples.controls.main_view = (function examples$controls$main_view(app_state,_owner){
if(typeof examples.controls.t_examples$controls172612 !== 'undefined'){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
examples.controls.t_examples$controls172612 = (function (main_view,app_state,_owner,meta172613){
this.main_view = main_view;
this.app_state = app_state;
this._owner = _owner;
this.meta172613 = meta172613;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
examples.controls.t_examples$controls172612.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_172614,meta172613__$1){
var self__ = this;
var _172614__$1 = this;
return (new examples.controls.t_examples$controls172612(self__.main_view,self__.app_state,self__._owner,meta172613__$1));
});

examples.controls.t_examples$controls172612.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_172614){
var self__ = this;
var _172614__$1 = this;
return self__.meta172613;
});

examples.controls.t_examples$controls172612.prototype.om$core$IRender$ = true;

examples.controls.t_examples$controls172612.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
var attrs172615 = om.core.build.call(null,examples.controls.simple_view,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(self__.app_state));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs172615))?sablono.interpreter.attributes.call(null,attrs172615):null),cljs.core.remove.call(null,cljs.core.nil_QMARK_,((cljs.core.map_QMARK_.call(null,attrs172615))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [React.createElement("div",null,React.createElement("div",null,"Data"),sablono.interpreter.interpret.call(null,om.core.build.call(null,examples.shared.utils.inspector_view,self__.app_state)))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs172615),React.createElement("div",null,React.createElement("div",null,"Data"),sablono.interpreter.interpret.call(null,om.core.build.call(null,examples.shared.utils.inspector_view,self__.app_state)))], null))));
});

examples.controls.t_examples$controls172612.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"main-view","main-view",1984529412,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta172613","meta172613",1079052577,null)], null);
});

examples.controls.t_examples$controls172612.cljs$lang$type = true;

examples.controls.t_examples$controls172612.cljs$lang$ctorStr = "examples.controls/t_examples$controls172612";

examples.controls.t_examples$controls172612.cljs$lang$ctorPrWriter = (function (this__5307__auto__,writer__5308__auto__,opt__5309__auto__){
return cljs.core._write.call(null,writer__5308__auto__,"examples.controls/t_examples$controls172612");
});

examples.controls.__GT_t_examples$controls172612 = (function examples$controls$main_view_$___GT_t_examples$controls172612(main_view__$1,app_state__$1,_owner__$1,meta172613){
return (new examples.controls.t_examples$controls172612(main_view__$1,app_state__$1,_owner__$1,meta172613));
});

}

return (new examples.controls.t_examples$controls172612(examples$controls$main_view,app_state,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
