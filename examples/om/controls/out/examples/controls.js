...
if(typeof examples.controls.t_examples$controls156616 !== 'undefined'){
} else {
...
*/
examples.controls.t_examples$controls156616 = (function (simple_view,data,_owner,meta156617){
this.simple_view = simple_view;
this.data = data;
this._owner = _owner;
this.meta156617 = meta156617;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
examples.controls.t_examples$controls156616.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_156618,meta156617__$1){
var self__ = this;
var _156618__$1 = this;
return (new examples.controls.t_examples$controls156616(self__.simple_view,self__.data,self__._owner,meta156617__$1));
});

examples.controls.t_examples$controls156616.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_156618){
var self__ = this;
var _156618__$1 = this;
return self__.meta156617;
});

examples.controls.t_examples$controls156616.prototype.om$core$IRender$ = true;

examples.controls.t_examples$controls156616.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return React.createElement("div",null,React.createElement("h1",{"key": "h1"},"Supported controls"),React.createElement("div",{"className": "row"},React.createElement("div",{"className": "col col-md-6"},React.createElement("h4",null,"Panel"),sablono.interpreter.interpret.call(null,reforms.om.panel.call(null,"Panel title",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 2"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 3"], null))),React.createElement("h4",null,"Auto-aligning form with validation"),sablono.interpreter.interpret.call(null,(function (){var _STAR_options_STAR_156639 = reforms.core.options._STAR_options_STAR_;
...
try{return reforms.om.form.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),((function (_STAR_options_STAR_156639,___$1){
return (function (){
return alert("Logging in");
});})(_STAR_options_STAR_156639,___$1))
...
}finally {reforms.core.options._STAR_options_STAR_ = _STAR_options_STAR_156639;
...
examples.controls.t_examples$controls156616.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"simple-view","simple-view",-1334203951,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"data","data",1407862150,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"data","data",1407862150,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta156617","meta156617",-1030366187,null)], null);
});

examples.controls.t_examples$controls156616.cljs$lang$type = true;

examples.controls.t_examples$controls156616.cljs$lang$ctorStr = "examples.controls/t_examples$controls156616";

examples.controls.t_examples$controls156616.cljs$lang$ctorPrWriter = (function (this__5307__auto__,writer__5308__auto__,opt__5309__auto__){
return cljs.core._write.call(null,writer__5308__auto__,"examples.controls/t_examples$controls156616");
});

examples.controls.__GT_t_examples$controls156616 = (function examples$controls$simple_view_$___GT_t_examples$controls156616(simple_view__$1,data__$1,_owner__$1,meta156617){
return (new examples.controls.t_examples$controls156616(simple_view__$1,data__$1,_owner__$1,meta156617));
});

}

return (new examples.controls.t_examples$controls156616(examples$controls$simple_view,data,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
examples.controls.main_view = (function examples$controls$main_view(app_state,_owner){
if(typeof examples.controls.t_examples$controls156648 !== 'undefined'){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
examples.controls.t_examples$controls156648 = (function (main_view,app_state,_owner,meta156649){
this.main_view = main_view;
this.app_state = app_state;
this._owner = _owner;
this.meta156649 = meta156649;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
examples.controls.t_examples$controls156648.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_156650,meta156649__$1){
var self__ = this;
var _156650__$1 = this;
return (new examples.controls.t_examples$controls156648(self__.main_view,self__.app_state,self__._owner,meta156649__$1));
});

examples.controls.t_examples$controls156648.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_156650){
var self__ = this;
var _156650__$1 = this;
return self__.meta156649;
});

examples.controls.t_examples$controls156648.prototype.om$core$IRender$ = true;

examples.controls.t_examples$controls156648.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
var attrs156651 = om.core.build.call(null,examples.controls.simple_view,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(self__.app_state));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs156651))?sablono.interpreter.attributes.call(null,attrs156651):null),cljs.core.remove.call(null,cljs.core.nil_QMARK_,((cljs.core.map_QMARK_.call(null,attrs156651))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [React.createElement("div",null,React.createElement("div",null,"Data"),sablono.interpreter.interpret.call(null,om.core.build.call(null,examples.shared.utils.inspector_view,self__.app_state)))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs156651),React.createElement("div",null,React.createElement("div",null,"Data"),sablono.interpreter.interpret.call(null,om.core.build.call(null,examples.shared.utils.inspector_view,self__.app_state)))], null))));
});

examples.controls.t_examples$controls156648.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"main-view","main-view",1984529412,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta156649","meta156649",3574954,null)], null);
});

examples.controls.t_examples$controls156648.cljs$lang$type = true;

examples.controls.t_examples$controls156648.cljs$lang$ctorStr = "examples.controls/t_examples$controls156648";

examples.controls.t_examples$controls156648.cljs$lang$ctorPrWriter = (function (this__5307__auto__,writer__5308__auto__,opt__5309__auto__){
return cljs.core._write.call(null,writer__5308__auto__,"examples.controls/t_examples$controls156648");
});

examples.controls.__GT_t_examples$controls156648 = (function examples$controls$main_view_$___GT_t_examples$controls156648(main_view__$1,app_state__$1,_owner__$1,meta156649){
return (new examples.controls.t_examples$controls156648(main_view__$1,app_state__$1,_owner__$1,meta156649));
});

}

return (new examples.controls.t_examples$controls156648(examples$controls$main_view,app_state,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
