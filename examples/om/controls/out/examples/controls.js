...
if(typeof examples.controls.t_examples$controls13484 !== 'undefined'){
} else {
...
*/
examples.controls.t_examples$controls13484 = (function (simple_view,data,_owner,meta13485){
...
examples.controls.t_examples$controls13484.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13486,meta13485__$1){
var self__ = this;
var _13486__$1 = this;
return (new examples.controls.t_examples$controls13484(self__.simple_view,self__.data,self__._owner,meta13485__$1));
});

examples.controls.t_examples$controls13484.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13486){
var self__ = this;
var _13486__$1 = this;
return self__.meta13485;
});

examples.controls.t_examples$controls13484.prototype.om$core$IRender$ = true;

examples.controls.t_examples$controls13484.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return React.createElement("div",null,React.createElement("h1",{"key": "h1"},"Supported controls"),React.createElement("div",{"className": "row"},React.createElement("div",{"className": "col col-md-6"},React.createElement("h4",null,"Panel"),sablono.interpreter.interpret.call(null,reforms.om.panel.call(null,"Panel title",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 2"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Contents 3"], null))),React.createElement("h4",null,"Auto-aligning form with validation"),sablono.interpreter.interpret.call(null,(function (){var _STAR_options_STAR_13507 = reforms.core.options._STAR_options_STAR_;
...
try{return reforms.om.form.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),((function (_STAR_options_STAR_13507,___$1){
return (function (){
return alert("Logging in");
});})(_STAR_options_STAR_13507,___$1))
...
}finally {reforms.core.options._STAR_options_STAR_ = _STAR_options_STAR_13507;
...
examples.controls.t_examples$controls13484.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"simple-view","simple-view",-1334203951,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"data","data",1407862150,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"data","data",1407862150,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta13485","meta13485",-914337454,null)], null);
});

examples.controls.t_examples$controls13484.cljs$lang$type = true;

examples.controls.t_examples$controls13484.cljs$lang$ctorStr = "examples.controls/t_examples$controls13484";

examples.controls.t_examples$controls13484.cljs$lang$ctorPrWriter = (function (this__5191__auto__,writer__5192__auto__,opt__5193__auto__){
return cljs.core._write.call(null,writer__5192__auto__,"examples.controls/t_examples$controls13484");
});

examples.controls.__GT_t_examples$controls13484 = (function examples$controls$simple_view_$___GT_t_examples$controls13484(simple_view__$1,data__$1,_owner__$1,meta13485){
return (new examples.controls.t_examples$controls13484(simple_view__$1,data__$1,_owner__$1,meta13485));
});

}

return (new examples.controls.t_examples$controls13484(examples$controls$simple_view,data,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
examples.controls.main_view = (function examples$controls$main_view(app_state,_owner){
if(typeof examples.controls.t_examples$controls13516 !== 'undefined'){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
examples.controls.t_examples$controls13516 = (function (main_view,app_state,_owner,meta13517){
...
examples.controls.t_examples$controls13516.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13518,meta13517__$1){
var self__ = this;
var _13518__$1 = this;
return (new examples.controls.t_examples$controls13516(self__.main_view,self__.app_state,self__._owner,meta13517__$1));
});

examples.controls.t_examples$controls13516.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13518){
var self__ = this;
var _13518__$1 = this;
return self__.meta13517;
});

examples.controls.t_examples$controls13516.prototype.om$core$IRender$ = true;

examples.controls.t_examples$controls13516.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
var attrs13519 = om.core.build.call(null,examples.controls.simple_view,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(self__.app_state));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs13519))?sablono.interpreter.attributes.call(null,attrs13519):null),cljs.core.remove.call(null,cljs.core.nil_QMARK_,((cljs.core.map_QMARK_.call(null,attrs13519))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [React.createElement("div",null,React.createElement("div",null,"Data"),sablono.interpreter.interpret.call(null,om.core.build.call(null,examples.shared.utils.inspector_view,self__.app_state)))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs13519),React.createElement("div",null,React.createElement("div",null,"Data"),sablono.interpreter.interpret.call(null,om.core.build.call(null,examples.shared.utils.inspector_view,self__.app_state)))], null))));
});

examples.controls.t_examples$controls13516.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"main-view","main-view",1984529412,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta13517","meta13517",-1703549703,null)], null);
});

examples.controls.t_examples$controls13516.cljs$lang$type = true;

examples.controls.t_examples$controls13516.cljs$lang$ctorStr = "examples.controls/t_examples$controls13516";

examples.controls.t_examples$controls13516.cljs$lang$ctorPrWriter = (function (this__5191__auto__,writer__5192__auto__,opt__5193__auto__){
return cljs.core._write.call(null,writer__5192__auto__,"examples.controls/t_examples$controls13516");
});

examples.controls.__GT_t_examples$controls13516 = (function examples$controls$main_view_$___GT_t_examples$controls13516(main_view__$1,app_state__$1,_owner__$1,meta13517){
return (new examples.controls.t_examples$controls13516(main_view__$1,app_state__$1,_owner__$1,meta13517));
});

}

return (new examples.controls.t_examples$controls13516(examples$controls$main_view,app_state,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
