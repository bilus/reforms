...
var len__5651__auto___10610 = arguments.length;
var i__5652__auto___10611 = (0);
while(true){
if((i__5652__auto___10611 < len__5651__auto___10610)){
args__5658__auto__.push((arguments[i__5652__auto___10611]));

var G__10612 = (i__5652__auto___10611 + (1));
i__5652__auto___10611 = G__10612;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq10609){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10609));
});
/**
...
var vec__10614 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__10614,(0),null);
var words = cljs.core.nthnext.call(null,vec__10614,(1));
...
var G__10616 = clojure.set.rename_keys.call(null,m,kmap);
var G__10616__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__10616,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__10616);
return G__10616__$1;
} else {
return m;
}
...
var args__5658__auto__ = [];
var len__5651__auto___10619 = arguments.length;
var i__5652__auto___10620 = (0);
while(true){
if((i__5652__auto___10620 < len__5651__auto___10619)){
args__5658__auto__.push((arguments[i__5652__auto___10620]));

var G__10621 = (i__5652__auto___10620 + (1));
i__5652__auto___10620 = G__10621;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__10617_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__10617_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__10617_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__10617_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq10618){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10618));
});
/**
...
var vec__10625 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__10625,(0),null);
var names = cljs.core.nth.call(null,vec__10625,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__10625,tag_name,names){
return (function (p1__10622_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__10622_SHARP_));
});})(matches,vec__10625,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__10625,tag_name,names){
return (function (p1__10623_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__10623_SHARP_));
});})(matches,vec__10625,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__10626){
var vec__10629 = p__10626;
var tag = cljs.core.nth.call(null,vec__10629,(0),null);
var content = cljs.core.nthnext.call(null,vec__10629,(1));
...
var vec__10630 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__10630,(0),null);
var id = cljs.core.nth.call(null,vec__10630,(1),null);
var class$ = cljs.core.nth.call(null,vec__10630,(2),null);
