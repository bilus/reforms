...
if(typeof examples.simple.t_examples$simple171923 !== 'undefined'){
} else {
...
*/
examples.simple.t_examples$simple171923 = (function (customer_form_view,customer,_owner,meta171924){
this.customer_form_view = customer_form_view;
this.customer = customer;
this._owner = _owner;
this.meta171924 = meta171924;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
examples.simple.t_examples$simple171923.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_171925,meta171924__$1){
var self__ = this;
var _171925__$1 = this;
return (new examples.simple.t_examples$simple171923(self__.customer_form_view,self__.customer,self__._owner,meta171924__$1));
});

examples.simple.t_examples$simple171923.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_171925){
var self__ = this;
var _171925__$1 = this;
return self__.meta171924;
});

examples.simple.t_examples$simple171923.prototype.om$core$IRender$ = true;

examples.simple.t_examples$simple171923.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
examples.simple.t_examples$simple171923.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"customer-form-view","customer-form-view",601730341,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"customer","customer",-911469450,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"customer","customer",-911469450,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta171924","meta171924",-1937564135,null)], null);
});

examples.simple.t_examples$simple171923.cljs$lang$type = true;

examples.simple.t_examples$simple171923.cljs$lang$ctorStr = "examples.simple/t_examples$simple171923";

examples.simple.t_examples$simple171923.cljs$lang$ctorPrWriter = (function (this__5307__auto__,writer__5308__auto__,opt__5309__auto__){
return cljs.core._write.call(null,writer__5308__auto__,"examples.simple/t_examples$simple171923");
});

examples.simple.__GT_t_examples$simple171923 = (function examples$simple$customer_form_view_$___GT_t_examples$simple171923(customer_form_view__$1,customer__$1,_owner__$1,meta171924){
return (new examples.simple.t_examples$simple171923(customer_form_view__$1,customer__$1,_owner__$1,meta171924));
});

}

return (new examples.simple.t_examples$simple171923(examples$simple$customer_form_view,customer,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
examples.simple.main_view = (function examples$simple$main_view(app_state,_owner){
if(typeof examples.simple.t_examples$simple171933 !== 'undefined'){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
examples.simple.t_examples$simple171933 = (function (main_view,app_state,_owner,meta171934){
this.main_view = main_view;
this.app_state = app_state;
this._owner = _owner;
this.meta171934 = meta171934;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
examples.simple.t_examples$simple171933.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_171935,meta171934__$1){
var self__ = this;
var _171935__$1 = this;
return (new examples.simple.t_examples$simple171933(self__.main_view,self__.app_state,self__._owner,meta171934__$1));
});

examples.simple.t_examples$simple171933.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_171935){
var self__ = this;
var _171935__$1 = this;
return self__.meta171934;
});

examples.simple.t_examples$simple171933.prototype.om$core$IRender$ = true;

examples.simple.t_examples$simple171933.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
examples.simple.t_examples$simple171933.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"main-view","main-view",1984529412,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null)], null)))], null)),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.Symbol(null,"_owner","_owner",1585448515,null),new cljs.core.Symbol(null,"meta171934","meta171934",330357096,null)], null);
});

examples.simple.t_examples$simple171933.cljs$lang$type = true;

examples.simple.t_examples$simple171933.cljs$lang$ctorStr = "examples.simple/t_examples$simple171933";

examples.simple.t_examples$simple171933.cljs$lang$ctorPrWriter = (function (this__5307__auto__,writer__5308__auto__,opt__5309__auto__){
return cljs.core._write.call(null,writer__5308__auto__,"examples.simple/t_examples$simple171933");
});

examples.simple.__GT_t_examples$simple171933 = (function examples$simple$main_view_$___GT_t_examples$simple171933(main_view__$1,app_state__$1,_owner__$1,meta171934){
return (new examples.simple.t_examples$simple171933(main_view__$1,app_state__$1,_owner__$1,meta171934));
});

}

return (new examples.simple.t_examples$simple171933(examples$simple$main_view,app_state,_owner,cljs.core.PersistentArrayMap.EMPTY));
});
