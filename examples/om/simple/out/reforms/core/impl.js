...
var G__8539__delegate = function (vals){
...
return G__8538.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__8538.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__8538);
} else {
return false;
}
}
...
while (G__8541__i < G__8541__a.length) {G__8541__a[G__8541__i] = arguments[G__8541__i + 0]; ++G__8541__i;}
...
while (G__8543__i < G__8543__a.length) {G__8543__a[G__8543__i] = arguments[G__8543__i + 0]; ++G__8543__i;}
  vals = new cljs.core.IndexedSeq(G__8543__a,0);
} 
return G__8539__delegate.call(this,vals);};
G__8539.cljs$lang$maxFixedArity = 0;
G__8539.cljs$lang$applyTo = (function (arglist__8544){
var vals = cljs.core.seq(arglist__8544);
return G__8539__delegate(vals);
});
...
var vec__8547 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__8547,(0),null);
var rest_args = cljs.core.nth.call(null,vec__8547,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__8547,attrs,rest_args){
...
});})(vec__8547,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__8547,attrs,rest_args){
return (function (p1__8545_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8545_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__8547,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__8549 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__8549,(0),null);
var rest_args = cljs.core.nth.call(null,vec__8549,(1),null);
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__8553){
var vec__8555 = p__8553;
var k = cljs.core.nth.call(null,vec__8555,(0),null);
var _v = cljs.core.nth.call(null,vec__8555,(1),null);
...
var vec__8560 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"feedback-icon","feedback-icon",1288816964)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__8560,(0),null);
...
reforms.core.impl.feedback_icon.cljs$lang$applyTo = (function (seq8559){
return reforms.core.impl.feedback_icon.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8559));
});
...
var vec__8562 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error-label","error-label",1393895243)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__8562,(0),null);
var vec__8563 = cljs.core.nth.call(null,vec__8562,(1),null);
var error = cljs.core.nth.call(null,vec__8563,(0),null);
...
reforms.core.impl.error_label.cljs$lang$applyTo = (function (seq8561){
return reforms.core.impl.error_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8561));
});
...
var vec__8565 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"warning-label","warning-label",-252042644)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__8565,(0),null);
var vec__8566 = cljs.core.nth.call(null,vec__8565,(1),null);
var warning = cljs.core.nth.call(null,vec__8566,(0),null);
...
reforms.core.impl.warning_label.cljs$lang$applyTo = (function (seq8564){
return reforms.core.impl.warning_label.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8564));
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq8567){
...
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__8568,G__8569,seq8567__$2);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq8570){
...
var G__8573 = cljs.core.first.call(null,seq8570__$2);
var seq8570__$3 = cljs.core.next.call(null,seq8570__$2);
var G__8574 = cljs.core.first.call(null,seq8570__$3);
var seq8570__$4 = cljs.core.next.call(null,seq8570__$3);
var G__8575 = cljs.core.first.call(null,seq8570__$4);
var seq8570__$5 = cljs.core.next.call(null,seq8570__$4);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__8571,G__8572,G__8573,G__8574,G__8575,seq8570__$5);
});
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__8583,inner){
var map__8584 = p__8583;
var map__8584__$1 = ((cljs.core.seq_QMARK_.call(null,map__8584))?cljs.core.apply.call(null,cljs.core.hash_map,map__8584):map__8584);
var valid_QMARK_ = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__8584__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq8576){
var G__8577 = cljs.core.first.call(null,seq8576);
var seq8576__$1 = cljs.core.next.call(null,seq8576);
var G__8578 = cljs.core.first.call(null,seq8576__$1);
var seq8576__$2 = cljs.core.next.call(null,seq8576__$1);
var G__8579 = cljs.core.first.call(null,seq8576__$2);
var seq8576__$3 = cljs.core.next.call(null,seq8576__$2);
var G__8580 = cljs.core.first.call(null,seq8576__$3);
var seq8576__$4 = cljs.core.next.call(null,seq8576__$3);
var G__8581 = cljs.core.first.call(null,seq8576__$4);
var seq8576__$5 = cljs.core.next.call(null,seq8576__$4);
var G__8582 = cljs.core.first.call(null,seq8576__$5);
var seq8576__$6 = cljs.core.next.call(null,seq8576__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__8577,G__8578,G__8579,G__8580,G__8581,G__8582,seq8576__$6);
});
...
return reforms.binding.core.reset_BANG_.call(null,cursor,korks,p1__8585_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq8586){
var G__8587 = cljs.core.first.call(null,seq8586);
var seq8586__$1 = cljs.core.next.call(null,seq8586);
var G__8588 = cljs.core.first.call(null,seq8586__$1);
var seq8586__$2 = cljs.core.next.call(null,seq8586__$1);
var G__8589 = cljs.core.first.call(null,seq8586__$2);
var seq8586__$3 = cljs.core.next.call(null,seq8586__$2);
var G__8590 = cljs.core.first.call(null,seq8586__$3);
var seq8586__$4 = cljs.core.next.call(null,seq8586__$3);
var G__8591 = cljs.core.first.call(null,seq8586__$4);
var seq8586__$5 = cljs.core.next.call(null,seq8586__$4);
var G__8592 = cljs.core.first.call(null,seq8586__$5);
var seq8586__$6 = cljs.core.next.call(null,seq8586__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__8587,G__8588,G__8589,G__8590,G__8591,G__8592,seq8586__$6);
});
/**
 * A spinner.
 * 
...
var vec__8594 = reforms.core.impl.resolve_args.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spinner","spinner",-646071217)], null),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__8594,(0),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),attrs], null);
});

reforms.core.impl.spinner.cljs$lang$maxFixedArity = (0);

reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq8593){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8593));
});
