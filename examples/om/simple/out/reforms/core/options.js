...
var args171990 = [];
var len__5767__auto___171993 = arguments.length;
var i__5768__auto___171994 = (0);
while(true){
if((i__5768__auto___171994 < len__5767__auto___171993)){
args171990.push((arguments[i__5768__auto___171994]));

var G__171995 = (i__5768__auto___171994 + (1));
i__5768__auto___171994 = G__171995;
continue;
} else {
}
break;
...
var G__171992 = args171990.length;
switch (G__171992) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args171990.length)].join('')));
