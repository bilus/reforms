...
var args164008 = [];
var len__5767__auto___164011 = arguments.length;
var i__5768__auto___164012 = (0);
while(true){
if((i__5768__auto___164012 < len__5767__auto___164011)){
args164008.push((arguments[i__5768__auto___164012]));

var G__164013 = (i__5768__auto___164012 + (1));
i__5768__auto___164012 = G__164013;
continue;
} else {
}
break;
...
var G__164010 = args164008.length;
switch (G__164010) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args164008.length)].join('')));
