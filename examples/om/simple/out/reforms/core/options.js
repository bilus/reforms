...
var args156026 = [];
var len__5767__auto___156029 = arguments.length;
var i__5768__auto___156030 = (0);
while(true){
if((i__5768__auto___156030 < len__5767__auto___156029)){
args156026.push((arguments[i__5768__auto___156030]));

var G__156031 = (i__5768__auto___156030 + (1));
i__5768__auto___156030 = G__156031;
continue;
} else {
}
break;
...
var G__156028 = args156026.length;
switch (G__156028) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args156026.length)].join('')));
