...
var args159381 = [];
var len__5767__auto___159384 = arguments.length;
var i__5768__auto___159385 = (0);
while(true){
if((i__5768__auto___159385 < len__5767__auto___159384)){
args159381.push((arguments[i__5768__auto___159385]));

var G__159386 = (i__5768__auto___159385 + (1));
i__5768__auto___159385 = G__159386;
continue;
} else {
}
break;
...
var G__159383 = args159381.length;
switch (G__159383) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args159381.length)].join('')));
