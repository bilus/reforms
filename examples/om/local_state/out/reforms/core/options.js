...
var args167363 = [];
var len__5767__auto___167366 = arguments.length;
var i__5768__auto___167367 = (0);
while(true){
if((i__5768__auto___167367 < len__5767__auto___167366)){
args167363.push((arguments[i__5768__auto___167367]));

var G__167368 = (i__5768__auto___167367 + (1));
i__5768__auto___167367 = G__167368;
continue;
} else {
}
break;
...
var G__167365 = args167363.length;
switch (G__167365) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args167363.length)].join('')));
