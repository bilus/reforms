...
var args175345 = [];
var len__5767__auto___175348 = arguments.length;
var i__5768__auto___175349 = (0);
while(true){
if((i__5768__auto___175349 < len__5767__auto___175348)){
args175345.push((arguments[i__5768__auto___175349]));

var G__175350 = (i__5768__auto___175349 + (1));
i__5768__auto___175349 = G__175350;
continue;
} else {
}
break;
...
var G__175347 = args175345.length;
switch (G__175347) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args175345.length)].join('')));
