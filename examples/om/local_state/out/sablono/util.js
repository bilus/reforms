...
var m__5365__auto__ = (sablono.util.to_str[goog.typeOf(x__5364__auto__)]);
if(!((m__5365__auto__ == null))){
return m__5365__auto__.call(null,x);
} else {
var m__5365__auto____$1 = (sablono.util.to_str["_"]);
...
var x__5364__auto__ = (((x == null))?null:x);
var m__5365__auto__ = (sablono.util.to_uri[goog.typeOf(x__5364__auto__)]);
if(!((m__5365__auto__ == null))){
return m__5365__auto__.call(null,x);
} else {
var m__5365__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__5365__auto____$1 == null))){
return m__5365__auto____$1.call(null,x);
} else {
...
var len__5767__auto___37071 = arguments.length;
var i__5768__auto___37072 = (0);
while(true){
if((i__5768__auto___37072 < len__5767__auto___37071)){
args__5774__auto__.push((arguments[i__5768__auto___37072]));

var G__37073 = (i__5768__auto___37072 + (1));
i__5768__auto___37072 = G__37073;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__5775__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq37070){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37070));
});
/**
...
var vec__37075 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__37075,(0),null);
var words = cljs.core.nthnext.call(null,vec__37075,(1));
...
var G__37077 = clojure.set.rename_keys.call(null,m,kmap);
var G__37077__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__37077,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__37077);
return G__37077__$1;
} else {
return m;
}
...
var args__5774__auto__ = [];
var len__5767__auto___37080 = arguments.length;
var i__5768__auto___37081 = (0);
while(true){
if((i__5768__auto___37081 < len__5767__auto___37080)){
args__5774__auto__.push((arguments[i__5768__auto___37081]));

var G__37082 = (i__5768__auto___37081 + (1));
i__5768__auto___37081 = G__37082;
continue;
} else {
}
break;
...
var argseq__5775__auto__ = ((((0) < args__5774__auto__.length))?(new cljs.core.IndexedSeq(args__5774__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5775__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__37078_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__37078_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__37078_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__37078_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq37079){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37079));
});
/**
...
var vec__37086 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__37086,(0),null);
var names = cljs.core.nth.call(null,vec__37086,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__37086,tag_name,names){
return (function (p1__37083_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__37083_SHARP_));
});})(matches,vec__37086,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__37086,tag_name,names){
return (function (p1__37084_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__37084_SHARP_));
});})(matches,vec__37086,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__37087){
var vec__37090 = p__37087;
var tag = cljs.core.nth.call(null,vec__37090,(0),null);
var content = cljs.core.nthnext.call(null,vec__37090,(1));
...
var vec__37091 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__37091,(0),null);
var id = cljs.core.nth.call(null,vec__37091,(1),null);
var class$ = cljs.core.nth.call(null,vec__37091,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4709__auto__ = x__$1.hasDomain();
