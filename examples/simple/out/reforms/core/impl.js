...
reforms.core.impl.input_column.cljs$lang$applyTo = (function (seq36550){
return reforms.core.impl.input_column.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36550));
});
/**
...
var m = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function reforms$core$impl$unstr_option_$_str__GT_orig(p__36554){
var vec__36556 = p__36554;
var k = cljs.core.nth.call(null,vec__36556,(0),null);
var _v = cljs.core.nth.call(null,vec__36556,(1),null);
...
reforms.core.impl.simple_checkbox.cljs$core$IFn$_invoke$arity$variadic = (function (checked,p__36560){
...
var on_click = cljs.core.get.call(null,map__36561__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"onChange","onChange",-312891301),((function (map__36561,map__36561__$1,on_click){
return (function (p1__36557_SHARP_){
return on_click.call(null,p1__36557_SHARP_.target.checked);
});})(map__36561,map__36561__$1,on_click))
...
reforms.core.impl.simple_checkbox.cljs$lang$applyTo = (function (seq36558){
var G__36559 = cljs.core.first.call(null,seq36558);
var seq36558__$1 = cljs.core.next.call(null,seq36558);
return reforms.core.impl.simple_checkbox.cljs$core$IFn$_invoke$arity$variadic(G__36559,seq36558__$1);
});
...
reforms.core.impl.unlabeled_control.cljs$lang$applyTo = (function (seq36562){
var G__36563 = cljs.core.first.call(null,seq36562);
var seq36562__$1 = cljs.core.next.call(null,seq36562);
return reforms.core.impl.unlabeled_control.cljs$core$IFn$_invoke$arity$variadic(G__36563,seq36562__$1);
});
...
reforms.core.impl.labeled_control.cljs$lang$applyTo = (function (seq36564){
...
var G__36568 = cljs.core.first.call(null,seq36564__$3);
var seq36564__$4 = cljs.core.next.call(null,seq36564__$3);
return reforms.core.impl.labeled_control.cljs$core$IFn$_invoke$arity$variadic(G__36565,G__36566,G__36567,G__36568,seq36564__$4);
});
...
var G__36572__delegate = function (vals){
...
return G__36571.cljs$core$Fn$;
}
})())){
return true;
} else {
if((!G__36571.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.Fn,G__36571);
} else {
return false;
}
}
...
return (function() { 
var G__36573__delegate = function (args){
...
while (G__36574__i < G__36574__a.length) {G__36574__a[G__36574__i] = arguments[G__36574__i + 0]; ++G__36574__i;}
  args = new cljs.core.IndexedSeq(G__36574__a,0);
} 
return G__36573__delegate.call(this,args);};
G__36573.cljs$lang$maxFixedArity = 0;
G__36573.cljs$lang$applyTo = (function (arglist__36575){
var args = cljs.core.seq(arglist__36575);
return G__36573__delegate(args);
});
...
while (G__36576__i < G__36576__a.length) {G__36576__a[G__36576__i] = arguments[G__36576__i + 0]; ++G__36576__i;}
  vals = new cljs.core.IndexedSeq(G__36576__a,0);
} 
return G__36572__delegate.call(this,vals);};
G__36572.cljs$lang$maxFixedArity = 0;
G__36572.cljs$lang$applyTo = (function (arglist__36577){
var vals = cljs.core.seq(arglist__36577);
return G__36572__delegate(vals);
});
...
var vec__36580 = reforms.core.impl.parse_args.call(null,args);
var attrs = cljs.core.nth.call(null,vec__36580,(0),null);
var rest_args = cljs.core.nth.call(null,vec__36580,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reforms.core.impl.merge_attrs.call(null,cljs.core.reduce.call(null,((function (vec__36580,attrs,rest_args){
...
});})(vec__36580,attrs,rest_args))
,cljs.core.map.call(null,((function (vec__36580,attrs,rest_args){
return (function (p1__36578_SHARP_){
return reforms.core.options.get_options.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36578_SHARP_,new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null));
});})(vec__36580,attrs,rest_args))
,ks)),attrs,ext_attrs),rest_args], null);
});
reforms.core.impl.parse_options = (function reforms$core$impl$parse_options(args){
var vec__36582 = cljs.core.split_with.call(null,cljs.core.comp.call(null,cljs.core.keyword_QMARK_,cljs.core.first),cljs.core.partition_all.call(null,(2),args));
var options = cljs.core.nth.call(null,vec__36582,(0),null);
var rest_args = cljs.core.nth.call(null,vec__36582,(1),null);
...
reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic = (function (tag,attrs,label,cursor,korks,p__36590,inner){
...
var valid_QMARK_ = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"valid?","valid?",-212412379));
var validation_error_fn = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"validation-error-fn","validation-error-fn",-625000244));
var in_progress = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"in-progress","in-progress",2126442630));
var warn_fn = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"warn-fn","warn-fn",1867170594));
var help = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"help","help",-439233446));
var inline = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"inline","inline",1399884222));
var large = cljs.core.get.call(null,map__36591__$1,new cljs.core.Keyword(null,"large","large",-196820544));
...
reforms.core.impl.input_STAR_.cljs$lang$applyTo = (function (seq36583){
...
var G__36588 = cljs.core.first.call(null,seq36583__$4);
var seq36583__$5 = cljs.core.next.call(null,seq36583__$4);
var G__36589 = cljs.core.first.call(null,seq36583__$5);
var seq36583__$6 = cljs.core.next.call(null,seq36583__$5);
return reforms.core.impl.input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__36584,G__36585,G__36586,G__36587,G__36588,G__36589,seq36583__$6);
});
...
return om.core.update_BANG_.call(null,cursor,korks,p1__36592_SHARP_.target.value);
});})(dom_id))
...
reforms.core.impl.html5_input_STAR_.cljs$lang$applyTo = (function (seq36593){
var G__36594 = cljs.core.first.call(null,seq36593);
var seq36593__$1 = cljs.core.next.call(null,seq36593);
var G__36595 = cljs.core.first.call(null,seq36593__$1);
var seq36593__$2 = cljs.core.next.call(null,seq36593__$1);
var G__36596 = cljs.core.first.call(null,seq36593__$2);
var seq36593__$3 = cljs.core.next.call(null,seq36593__$2);
var G__36597 = cljs.core.first.call(null,seq36593__$3);
var seq36593__$4 = cljs.core.next.call(null,seq36593__$3);
var G__36598 = cljs.core.first.call(null,seq36593__$4);
var seq36593__$5 = cljs.core.next.call(null,seq36593__$4);
var G__36599 = cljs.core.first.call(null,seq36593__$5);
var seq36593__$6 = cljs.core.next.call(null,seq36593__$5);
return reforms.core.impl.html5_input_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__36594,G__36595,G__36596,G__36597,G__36598,G__36599,seq36593__$6);
});
/**
 * A spinner.
 * 
...
var vec__36601 = reforms.core.impl.resolve_args.call(null,new cljs.core.Keyword(null,"spinner","spinner",-646071217),cljs.core.PersistentArrayMap.EMPTY,args);
var attrs = cljs.core.nth.call(null,vec__36601,(0),null);
...
reforms.core.impl.spinner.cljs$lang$applyTo = (function (seq36600){
return reforms.core.impl.spinner.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36600));
});
