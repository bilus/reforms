...
sablono.util.ToString = (function (){var obj8496 = {};
return obj8496;
})();
...
return (function (){var or__4335__auto__ = (sablono.util.to_str[goog.typeOf(x__4971__auto__)]);
if(or__4335__auto__){
return or__4335__auto__;
} else {
var or__4335__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj8498 = {};
return obj8498;
})();
...
var x__4971__auto__ = (((x == null))?null:x);
return (function (){var or__4335__auto__ = (sablono.util.to_uri[goog.typeOf(x__4971__auto__)]);
if(or__4335__auto__){
return or__4335__auto__;
} else {
var or__4335__auto____$1 = (sablono.util.to_uri["_"]);
if(or__4335__auto____$1){
return or__4335__auto____$1;
} else {
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__5375__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq8499){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8499));
});
/**
...
var vec__8501 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__8501,(0),null);
var words = cljs.core.nthnext.call(null,vec__8501,(1));
...
var G__8503 = clojure.set.rename_keys.call(null,m,kmap);
var G__8503__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__8503,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__8503);
return G__8503__$1;
} else {
return m;
}
...
var argseq__5375__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5375__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__8504_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__8504_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8504_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__8504_SHARP_)){
return p1__8504_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8504_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq8505){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8505));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__8509,(0),null);
var names = cljs.core.nth.call(null,vec__8509,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8509,tag_name,names){
return (function (p1__8506_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__8506_SHARP_));
});})(matches,vec__8509,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8509,tag_name,names){
return (function (p1__8507_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__8507_SHARP_));
});})(matches,vec__8509,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__8510){
var vec__8513 = p__8510;
var tag = cljs.core.nth.call(null,vec__8513,(0),null);
var content = cljs.core.nthnext.call(null,vec__8513,(1));
...
var vec__8514 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__8514,(0),null);
var id = cljs.core.nth.call(null,vec__8514,(1),null);
var class$ = cljs.core.nth.call(null,vec__8514,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4335__auto__ = x__$1.hasDomain();
