...
var m__5249__auto__ = (sablono.util.to_str[goog.typeOf(x__5248__auto__)]);
if(!((m__5249__auto__ == null))){
return m__5249__auto__.call(null,x);
} else {
var m__5249__auto____$1 = (sablono.util.to_str["_"]);
...
var x__5248__auto__ = (((x == null))?null:x);
var m__5249__auto__ = (sablono.util.to_uri[goog.typeOf(x__5248__auto__)]);
if(!((m__5249__auto__ == null))){
return m__5249__auto__.call(null,x);
} else {
var m__5249__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__5249__auto____$1 == null))){
return m__5249__auto____$1.call(null,x);
} else {
...
var len__5651__auto___11540 = arguments.length;
var i__5652__auto___11541 = (0);
while(true){
if((i__5652__auto___11541 < len__5651__auto___11540)){
args__5658__auto__.push((arguments[i__5652__auto___11541]));

var G__11542 = (i__5652__auto___11541 + (1));
i__5652__auto___11541 = G__11542;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__5659__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq11539){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11539));
});
/**
...
var vec__11544 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__11544,(0),null);
var words = cljs.core.nthnext.call(null,vec__11544,(1));
...
var G__11546 = clojure.set.rename_keys.call(null,m,kmap);
var G__11546__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__11546,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__11546);
return G__11546__$1;
} else {
return m;
}
...
var args__5658__auto__ = [];
var len__5651__auto___11549 = arguments.length;
var i__5652__auto___11550 = (0);
while(true){
if((i__5652__auto___11550 < len__5651__auto___11549)){
args__5658__auto__.push((arguments[i__5652__auto___11550]));

var G__11551 = (i__5652__auto___11550 + (1));
i__5652__auto___11550 = G__11551;
continue;
} else {
}
break;
...
var argseq__5659__auto__ = ((((0) < args__5658__auto__.length))?(new cljs.core.IndexedSeq(args__5658__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5659__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__11547_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__11547_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__11547_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__11547_SHARP_)){
return p1__11547_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__11547_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq11548){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11548));
});
/**
...
var vec__11555 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__11555,(0),null);
var names = cljs.core.nth.call(null,vec__11555,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__11555,tag_name,names){
return (function (p1__11552_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__11552_SHARP_));
});})(matches,vec__11555,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__11555,tag_name,names){
return (function (p1__11553_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__11553_SHARP_));
});})(matches,vec__11555,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__11556){
var vec__11559 = p__11556;
var tag = cljs.core.nth.call(null,vec__11559,(0),null);
var content = cljs.core.nthnext.call(null,vec__11559,(1));
...
var vec__11560 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__11560,(0),null);
var id = cljs.core.nth.call(null,vec__11560,(1),null);
var class$ = cljs.core.nth.call(null,vec__11560,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4593__auto__ = x__$1.hasDomain();
