...
goog.provide('reforms.rum');
goog.require('cljs.core');
goog.require('reforms.core');
goog.require('reforms.binding.rum');
/**
 ...
 */
reforms.rum.form = reforms.core.form;

reforms.rum.get_options = reforms.core.get_options;
 ...
 * See `button`.
 */
reforms.rum.button_primary = reforms.core.button_primary;
 ...
 */
reforms.rum.text = reforms.core.text;
 ...
 *         [[:option1 "Option 1"] [:option2 "Option 2"] [:option3 "Option 3"]])
 */
reforms.rum.select = reforms.core.select;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.datetime_local = reforms.core.datetime_local;
 ...
 * See `button`.
 */
reforms.rum.button_default = reforms.core.button_default;
 ...
 * button-1 ... button-n
 */
reforms.rum.form_buttons = reforms.core.form_buttons;
 ...
 */
reforms.rum.html5_input = reforms.core.html5_input;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.email = reforms.core.email;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.date = reforms.core.date;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.week = reforms.core.week;
 ...
 */
reforms.rum.group_title = reforms.core.group_title;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.color = reforms.core.color;
 ...
 * - :validation-error-fn  - (optional) lambda <korks> -> <error message>; internal
 */
reforms.rum.radio = reforms.core.radio;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.number = reforms.core.number;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.password = reforms.core.password;
 ...
 * - :validation-error-fn  - (optional) lambda <korks> -> <error message>; internal
 */
reforms.rum.checkbox = reforms.core.checkbox;
 ...
 */
reforms.rum.button = reforms.core.button;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.time = reforms.core.time;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.month = reforms.core.month;

reforms.rum.set_options_BANG_ = reforms.core.set_options_BANG_;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.search = reforms.core.search;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.tel = reforms.core.tel;
 ...
 * - attrs                 - (optional) attributes handed over to React (see https://github.com/r0man/sablono#html-attributes)
 */
reforms.rum.spinner = reforms.core.spinner;
 ...
 *         [:div "Contents go here"])
 */
reforms.rum.panel = reforms.core.panel;
 ...
 */
reforms.rum.textarea = reforms.core.textarea;
 ...
 * - attrs        - (optional) attributes handed over to React (see https://github.com/r0man/sablono#html-attributes)
 */
reforms.rum.button_group = reforms.core.button_group;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.datetime = reforms.core.datetime;
 ...
 * For compatilibity and available attributes see http://www.w3schools.com/html/html_form_input_types.asp
 */
reforms.rum.url = reforms.core.url;
