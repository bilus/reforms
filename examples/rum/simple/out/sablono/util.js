...
var len__5651__auto___8335 = arguments.length;
var i__5652__auto___8336 = (0);
while(true){
if((i__5652__auto___8336 < len__5651__auto___8335)){
args__5658__auto__.push((arguments[i__5652__auto___8336]));

var G__8337 = (i__5652__auto___8336 + (1));
i__5652__auto___8336 = G__8337;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq8334){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8334));
});
/**
...
var vec__8339 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__8339,(0),null);
var words = cljs.core.nthnext.call(null,vec__8339,(1));
...
var G__8341 = clojure.set.rename_keys.call(null,m,kmap);
var G__8341__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__8341,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__8341);
return G__8341__$1;
} else {
return m;
}
...
var args__5658__auto__ = [];
var len__5651__auto___8344 = arguments.length;
var i__5652__auto___8345 = (0);
while(true){
if((i__5652__auto___8345 < len__5651__auto___8344)){
args__5658__auto__.push((arguments[i__5652__auto___8345]));

var G__8346 = (i__5652__auto___8345 + (1));
i__5652__auto___8345 = G__8346;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__8342_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__8342_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8342_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__8342_SHARP_)){
return p1__8342_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8342_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq8343){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8343));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__8350,(0),null);
var names = cljs.core.nth.call(null,vec__8350,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8350,tag_name,names){
return (function (p1__8347_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__8347_SHARP_));
});})(matches,vec__8350,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8350,tag_name,names){
return (function (p1__8348_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__8348_SHARP_));
});})(matches,vec__8350,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__8351){
var vec__8354 = p__8351;
var tag = cljs.core.nth.call(null,vec__8354,(0),null);
var content = cljs.core.nthnext.call(null,vec__8354,(1));
...
var vec__8355 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__8355,(0),null);
var id = cljs.core.nth.call(null,vec__8355,(1),null);
var class$ = cljs.core.nth.call(null,vec__8355,(2),null);
