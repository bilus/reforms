...
- [Usage](#usage)
  ...
  - [Customization](#customization)
    ...
    - [Configuration via `with-options`](#configuration-via-with-options)
    - [Element attributes](#element-attributes)
  - [Demos](#demos)
  - [FAQ](#faq)
    - [How do I submit the form when the user presses ENTER?](#how-do-i-submit-the-form-when-the-user-presses-enter)
    - [How to store validation errors in local state?](#how-to-store-validation-errors-in-local-state)
    - [How to save changes to data when user clicks a button?](#how-to-save-changes-to-data-when-user-clicks-a-button)
    - [How to show an operation is in progress?](#how-to-show-an-operation-is-in-progress)
    - [Can I use built-in Bootstrap icons instead of Font Awesome?](#can-i-use-built-in-bootstrap-icons-instead-of-font-awesome)
